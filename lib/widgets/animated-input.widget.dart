...
class AnimatedInput extends StatelessWidget {
  ...
  AnimatedInput({this.controller})
      : containerOpacityAnim = Tween(begin: 0.0, end: 1.0).animate(
        ...
        containerSizeAnim = Tween(begin: 60.0, end: 280.0).animate(
          CurvedAnimation(
            parent: controller,
            curve: Interval(0.2, 0.3),
          ),
        ),
        containerBorderRadiusAnim = Tween(begin: 0.0, end: 30.0).animate(
          CurvedAnimation(
            parent: controller,
        ...
        containerColorAnim =
            ColorTween(begin: Colors.white.withOpacity(0), end: Colors.black12)
                .animate(
          CurvedAnimation(
            parent: controller,
